...
namespace LuaPlayer
{
    ...
    */
    ...
    // int GetPetStable(lua_State* L, Player* player)
    // {
    //     Eluna::Push(L, player->GetPetStable());
    //     return 1;
    // }

    // int GetOrInitPetStable(lua_State* L, Player* player)
    // {
    //     Eluna::Push(L, &player->GetOrInitPetStable());
    //     return 1;
    // }
};
#endif
